<template>
    <section
        class="w-full min-h-svh px-6 flex flex-col items-center justify-center text-lg lg:text-2xl text-center gap-y-4">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full">
            <div class="w-full order-1 lg:order-2 flex justify-center items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-full md:h-svh py-6" viewBox="0 0 746 721.34323"
                    ...
                    <path
                        ...
                        transform="translate(-227 -89.32838)" fill="#6c63ff" />
                    <path
            ...
            <div class="w-full order-2 lg:order-1 py-6 flex gap-4 flex-col justify-between h-full items-center">
                ...
                <div class="px-4 py-6 w-full flex justify-center items-center">
                    <NuxtLink
                        class="py-4 px-6 w-fit backdrop-blur-xs transition-colors duration-300 hover:bg-violet-600 hover:text-white text-xl text-center rounded-xl block bg-neutral-900/10"
                        to="/">
                        {{ $t('back') }}
                    </NuxtLink>
                </div>
