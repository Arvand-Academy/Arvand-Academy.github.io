<template>
  <section id="agents" class="w-full min-h-svh flex flex-col md:flex-row justify-around items-center px-4">
    <div>
      <svg xmlns="http://www.w3.org/2000/svg" class="w-32 h-32 md:w-128 md:h-128" id="asvg" viewBox="0 0 24 24">
    ...
    <div class="max-w-128 text-lg sm:text-xl text-center md:mt-2">
      <ul class="flex flex-col gap-1">
        <li class="mb-2"><h3 class="text-3xl uppercase border-b-1 border-blue-600 dark:border-green-400">{{ $t('agents')  }}</h3></li>
