<template>
  <section id="services" class="w-full min-h-svh flex flex-col md:flex-row justify-around items-center px-4">
    <div>
    <svg xmlns="http://www.w3.org/2000/svg" class="w-32 h-32 md:w-128 md:h-128" viewBox="0 0 24 24" id="ssvg">
    ...
    <div class="max-w-128 text-lg sm:text-xl text-center md:mt-2">
      <ul class="flex flex-col gap-1">
        <li class="mb-2"><h3 class="text-3xl uppercase">{{ $t('services')  }}</h3></li>
        <li class="border-b-1 border-blue-600 dark:border-green-400" id="s1">{{ $t('s1')  }}</li>
        <li class="border-b-1 border-blue-600 dark:border-green-400" id="s2">{{ $t('s2')  }}</li>
        <li class="border-b-1 border-blue-600 dark:border-green-400" id="s3">{{ $t('s3')  }}</li>
        <li class="border-b-1 border-blue-600 dark:border-green-400" id="s4">{{ $t('s4')  }}</li>
        <li class="border-b-1 border-blue-600 dark:border-green-400" id="s5">{{ $t('s5')  }}</li>
        <li class="border-b-1 border-blue-600 dark:border-green-400" id="s6">{{ $t('s6')  }}</li>
        <li class="border-b-1 border-blue-600 dark:border-green-400" id="s7">{{ $t('s7')  }}</li>
        <li class="border-b-1 border-blue-600 dark:border-green-400" id="s8">{{ $t('s8')  }}</li>
        <li class="border-b-1 border-blue-600 dark:border-green-400" id="s9">{{ $t('s9')  }}</li>
        <li class="border-b-1 border-blue-600 dark:border-green-400" id="s10">{{ $t('s10')  }}</li>
        <li class="border-b-1 border-blue-600 dark:border-green-400" id="s11">{{ $t('s11')  }}</li>
        <li class="border-b-1 border-blue-600 dark:border-green-400" id="s12">{{ $t('s12')  }}</li>
        <li class="border-b-1 border-blue-600 dark:border-green-400" id="s13">{{ $t('s13')  }}</li>
        <li class="border-b-1 border-blue-600 dark:border-green-400" id="s14">{{ $t('s14')  }}</li>
        <li class="border-b-1 border-blue-600 dark:border-green-400" id="s15">{{ $t('s15')  }}</li>
      </ul>
    </div>
  </section>
</template>
